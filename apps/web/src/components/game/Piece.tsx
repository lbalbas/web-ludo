...
export function Piece({ color, onClick }: PieceProps) {
  ...
  return (
    <div
      onClick={onClick}
      className={`absolute inset-1 m-auto w-10 h-10 rounded-full bg-gradient-to-br shadow-lg border-2 cursor-pointer transition-transform hover:scale-110 active:scale-95 z-10 ${colorMap[color]}`}
    >
